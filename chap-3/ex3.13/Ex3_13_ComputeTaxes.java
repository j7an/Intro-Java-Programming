...
public class Ex3_13_ComputeTaxes {
	public static void main(String[] args) {
		final int single10Max = 8350,
				...
				separate15Max = 33950,
				separate25Max = 68525,
				separate28Max = 104425,
				separate33Max = 186475,
				head10Max = 11950,
				head15Max = 45500,
				head25Max = 117450,
				head28Max = 190200,
		...
		if (status == 0) { // Compute tax for single filers
			if (income <= single10Max)
				...
				tax = single10Max * 0.10 + (single15Max - single10Max) * 0.15 + (single25Max - single15Max) * 0.25 + (income - single25Max) * 0.28;
			else if (income <= single33Max)
				tax = single10Max * 0.10 + (single15Max - single10Max) * 0.15 + (single25Max - single15Max) * 0.25 + (single28Max - single25Max) * 0.28
						+ (income - single28Max) * 0.33;
			else
				tax = single10Max * 0.10 + (single15Max - single10Max) * 0.15 + (single25Max - single15Max) * 0.25 + (single28Max - single25Max) * 0.28
						+ (single33Max - single28Max) * 0.33 + (income - single33Max) * 0.35;
			...
			if (income <= joint10Max)
				...
				tax = joint10Max * 0.10 + (joint15Max - joint10Max) * 0.15 + (joint25Max - joint15Max) * 0.25 + (income - joint25Max) * 0.28;
			else if (income <= joint33Max)
				tax = joint10Max * 0.10 + (joint15Max - joint10Max) * 0.15 + (joint25Max - joint15Max) * 0.25 + (joint28Max - joint25Max) * 0.28
						+ (income - joint28Max) * 0.33;
			else
				tax = joint10Max * 0.10 + (joint15Max - joint10Max) * 0.15 + (joint25Max - joint15Max) * 0.25 + (joint28Max - joint25Max) * 0.28
						+ (joint33Max - joint28Max) * 0.33 + (income - joint33Max) * 0.35;
			...
			if (income <= separate10Max)
				...
				tax = separate10Max * 0.10 + (separate15Max - separate10Max) * 0.15 + (separate25Max - separate15Max) * 0.25 + (income - separate25Max) * 0.28;
			else if (income <= separate33Max)
				tax = separate10Max * 0.10 + (separate15Max - separate10Max) * 0.15 + (separate25Max - separate15Max) * 0.25 + (separate28Max - separate25Max) * 0.28
						+ (income - separate28Max) * 0.33;
			else
				tax = separate10Max * 0.10 + (separate15Max - separate10Max) * 0.15 + (separate25Max - separate15Max) * 0.25 + (separate28Max - separate25Max) * 0.28
						+ (separate33Max - separate28Max) * 0.33 + (income - separate33Max) * 0.35;
			...
			if (income <= head10Max)
				...
				tax = head10Max * 0.10 + (head15Max - head10Max) * 0.15 + (head25Max - head15Max) * 0.25 + (income - head25Max) * 0.28;
			else if (income <= head33Max)
				tax = head10Max * 0.10 + (head15Max - head10Max) * 0.15 + (head25Max - head15Max) * 0.25 + (head28Max - head25Max) * 0.28
						+ (income - head28Max) * 0.33;
			else
				tax = head10Max * 0.10 + (head15Max - head10Max) * 0.15 + (head25Max - head15Max) * 0.25 + (head28Max - head25Max) * 0.28
						+ (head33Max - head28Max) * 0.33 + (income - head33Max) * 0.35;
		} else {
